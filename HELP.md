...
* The original package name 'com.example.full-stack-application.Full Stack Application' is invalid and this project uses 'com.example.fullstackapplication.Full.Stack.Application' instead.
